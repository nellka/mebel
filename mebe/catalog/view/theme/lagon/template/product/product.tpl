...
<?php echo $content_top; ?>
    ...
    <div class="right">
      ...
      <div class="cart">
        ...
        <div class="wish-compare">
          <a class="wish" onclick="addToWishList('<?php echo $product_id; ?>');" title="<?php echo $button_wishlist; ?>"></a>
          <a class="compare" onclick="addToCompare('<?php echo $product_id; ?>');" title="<?php echo $button_compare; ?>"></a>
        </div>
        <?php if ($minimum > 1) { ?>
      ...
      <div class="review">
        ...
        <img class="review-img" src="catalog/view/theme/lagon/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
  ...
  <div class="related-product">
  	<h2 class="realted-title"><?php echo $tab_related; ?></h2>
    <div class="box-product box">
      ...
      <div class="related">
        ...
        <?php } ?>
        <div class="name" style="height:36px;width:100%"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/lagon/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/lagon/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
