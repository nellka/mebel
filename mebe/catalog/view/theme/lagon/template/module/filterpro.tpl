...
<div class="box-heading"><span>Фильтры</span><div style="height: 15px; float: right;">
...
<div class="option_box">
	...
	<div class="option_box">
		...
		<?php } ?>
	<?php } ?>
<?php if (isset($filer_special)&& $filer_special) {?>
	<div class="option_box">
...
$(document).ready(function () {
   // initfilter(jQuery.parseJSON('<?php echo (array)$filterOptions;?>'));
});
