...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if ($category['top']) {  $children_data = array(); 
		$children = $this->model_catalog_category->getCategories($category['category_id']);                  
		foreach ($children as $child) { $sec_children_data = array(); 
		$sec_children = $this->model_catalog_category->getCategories($child['category_id']);		
		foreach ($sec_children as $sec_child) { $sec_children_data[] = array(  
		
		'name'  => $sec_child['name'],  
		'category_id' =>$sec_child["category_id"],                           
		'href'  => $this->url->link('product/category', 
		'path=' . $child['category_id'] . '_' . $sec_child['category_id']) ); }  $data = array(                         
