  ...
  return {
          ...
          if(element.price_course && !element.variants){
           ...
           if(element.variants){
             element.variants.forEach(function (variant, index, array) {
              ...
              tdPrice +='<tr><td><span style="color:#08C;">'+variant.title_variant+'</span></td><td><input style="width: 45px;" class="variant-price fastsave" type="text" value="'+variant.price+'" data-packet="{variant:1,id:'+variant.id+',field:\'price\'}"/></td><td>'+ catalog.getShortIso(element.currency_iso) +'</td><div class="clear"></div></tr>';
             }
           );                    
          }else{
            tdPrice += '<tr><td></td><td><input style="width: 45px;" type="text" value="'+element.real_price+'" class="fastsave" data-packet="{variant:0,id:'+element.id+',field:\'price\'}"/></td><td> '+catalog.getShortIso(element.currency_iso)+'</td></tr>';
          }
          ...
          if(printPrice){
           ...
           if(element.variants){
             element.variants.forEach(function (variant, index, array) {                
               ...
               tdCount +='<input style="width: 25px; '+margin+'" class="variant-count fastsave" type="text" value="'+variant.count+'" data-packet="{variant:1,id:'+variant.id+',field:\'count\'}"/> '+lang.UNIT+'<div class="clear"></div>';
             }
           );                                
          }else{
            if(element.count<0){element.count='∞'}
            tdCount += '<input style="width: 25px; '+margin+'" type="text" value="'+element.count+'" class="fastsave" data-packet="{variant:0,id:'+element.id+',field:\'count\'}"/> '+lang.UNIT;                               
          }
          tdCount += '</td>'
    ...
    */
    addImageToProduct:function(img_container) {
      ...
      var currentImg = img_container.find('.prev-img img').attr('alt');
    ...
    */
      ...
      if(variants){
        ...
        $('.variant-table').append(position);  
          ...
          <tr class="variant-row">\
            ...
            <td>\
              <label for="code"><input style="width: 50px;" type="text" name="code" value="" class="product-name-input tool-tip-right" title="'+lang.T_TIP_CODE_PROD+'" ><div class="errorField">'+lang.ERROR_EMPTY+'</div></label>\
            </td>\
            <td>\
    ...
    addVariant:function(table) {      
      ...
      <tr class="variant-row">\
        ...
        <td>\
          <label for="code"><input style="width: 50px;"  type="text" name="code" class="product-name-input tool-tip-right" title="'+lang.T_TIP_CODE_PROD+'" ><div class="errorField">'+lang.ERROR_EMPTY+'</div></label>\
        </td>\
        <td>\
    ...
    rowRelatedProduct: function(product) {    
      ...
      <div class="product-unit" data-id='+ product.id +' data-code="'+ product.code +'">\
          <div class="product-img">\
              <a href="javascript:void(0);"><img src="' + admin.SITE + '/uploads/thumbs/30_' + product.image_url + '"></a>\
          </div>\
          <a href="' + mgBaseDir + '/' + product.category_url + "/" + product.product_url +
              ...
              product.title + '">' +
              product.title + '</a>\
          <span>' + admin.numberFormat(product.price) +' '+ admin.CURRENCY+'</span>\
