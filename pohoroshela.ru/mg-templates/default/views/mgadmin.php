...
if(USER::isAuth() && ('1' == USER::getThis()->role || '3' == USER::getThis()->role || '4' == USER::getThis()->role)): ?>
 ...
 <?php MG::titlePage($lang['ADMIN_BAR']);?>
    ...
    <script> var lang = <?php echo json_encode($lang)?>; var SITE = "<?php echo SITE; ?>";</script>
    ...
    <script type="text/javascript" src="<?php echo SITE?>/mg-core/script/admin/admin.js?protocol=<?php echo PROTOCOL; ?>&amp;mgBaseDir=<?php echo SITE; ?>&amp;currency=<?php echo MG::getSetting('currency'); ?>"></script>
