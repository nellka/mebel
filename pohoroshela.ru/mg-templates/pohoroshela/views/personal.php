...
?>
<h1 class="new-products-title js_accordionOpen">Личный кабинет пользователя "<?php echo $userInfo->name ?>"</h1>
<?php if ($data['message']): ?>
...
<div class="create-user-account-form">
    <div class="personal-tabs">
        <ul class="personal-tabs-list uk-tab">
            ...
            <div class="order-history-list">
                ...
                <div class="order-history" id="<?php echo $order['id'] ?>">
                    <div class="order-number">
                        ...
                        <table class="status-table uk-table uk-table-condensed">
                            <tr>
                                <th>Товар</th>
                                <th>Артикул</th>
                                <th>Цена</th>
                    ...
                    <div class="order-total">
                        <ul class="total-list">
                            ...
                            <li>Дата доставки: <span><?php echo $order['date_delivery'] ?></span></li>
                            <?php endif; ?>
                            <?php endif; ?>
                    ...
                    <div class="js_sectionButton">
                       ...
                       <!-- <div class="order-settings">
                        ...
                        <div class="order-settings">
                            <button class="close-order uk-button uk-button-small" id="<?php echo $order['id'] ?>" date="<?php echo date('d.m.Y', strtotime($order['add_date'])) ?>" data-number="<?php echo $order['number'] != ''? $order['number']: $order['id'];?>" href="#openModal">
                            Отменить заказ
                            </button>
                            <br/>
                ...
                <div class="close-reason">
                    ...
                    <div class="close-reason-wrapper" id="openModal">
                        <p class="order-number">Закрытие заказа <br /> №<strong name="orderId" class="orderId"></strong> от <span class="orderDate"></span></p>
