...
/*
  ...
  Description: Плагин создает миниатюры для загруженых картинок товаров, необходимых для корректного отображения фотографий процукции в магазине. Для корректной работы плагина создайте в uploads папку tempimage.
  Author: Avdeev Mark
  Version: 1.0.2
 */
