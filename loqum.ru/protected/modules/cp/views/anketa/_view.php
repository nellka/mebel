<div class="view">
	...
	<?php echo CHtml::encode($data->zodiac); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('mainphoto')); ?>:</b>
	<?php echo CHtml::encode($data->mainphoto); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('isinactive')); ?>:</b>
	<?php echo CHtml::encode($data->isinactive); ?>
	<br />
