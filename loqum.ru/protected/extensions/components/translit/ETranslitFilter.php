...
class ETranslitFilter extends CValidator
{
    ...
    /**
     * @var bool conver to lowercase - for URL
     */
    public $toLower = true;
    /**
     * @var bool replace Slashes \/ to _under_score_
     */
    public $replaceSlashes = true;
    /**
     * @var bool Remove non-latin and some other characters (-_a-zA-Z0-9)
     */
    public $removeNonLatin = true;
	/**
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		if ($this->toLower) $object->$attribute = strtolower ($object->$attribute); //mb_
		if ($this->replaceSlashes) $object->$attribute = preg_replace ('#\\/#','-',$object->$attribute); //mb_
        if ($this->removeNonLatin) $object->$attribute = preg_replace('/[^A-Za-z0-9_\-]/', '', $object->$attribute);
	}
	/**
