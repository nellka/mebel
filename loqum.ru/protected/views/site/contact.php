...
<p>
Есть вопросы? Предложения? Пожелания? Пишите!<br/>
<a href="/anketa/503894">Администратор</a> или на почту <a href="mailto:<?=Yii::app()->params['adminEmail']?>"><?=Yii::app()->params['adminEmail']?></a> или заполните форму:
</p>
