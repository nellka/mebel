...
//            array('label'=>'Помощь', 'url'=>array('/site/page','view'=>'about'),'itemOptions'=>array('class'=>'right')),
    ...
    if ($this->action->id == 'search' || ($this->action->id=='index' && $this->id == 'anketa') || ($this->id=='city' ))
    ...
    <div class="footer nuclear">
        ...
        <div class="mdl-f">
            ...
            <span class="copy">© 2008-<?=date('Y');?> www.muksil.ru</span>
        </div>
        <div class="counter">
        ...
        //--></script><!--/LiveInternet-->
            <!--a href="#"><img src="<?=Yii::app()->theme->baseUrl;?>/images/c01.gif" alt=""/></a>
            <a href="#"><img src="<?=Yii::app()->theme->baseUrl;?>/images/c02.gif" alt=""/></a>
            <a href="#"><img src="<?=Yii::app()->theme->baseUrl;?>/images/c03.gif" alt=""/></a-->
        </div>
    </div>
    <!--/ footer -->
</div>
